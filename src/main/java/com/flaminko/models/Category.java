...
public class Category  implements java.io.Serializable {
    ...
    public Category(CategoryId id,  String categoryName, String image) {
        this.id = id;
    ...
    public Category(CategoryId id, String categoryName, String image, Set<Product> products, Set<Category> categories) {
        this.id = id;
        this.categoryName = categoryName;
        this.image = image;
    ...
    public Category(CategoryId id, Category category, String categoryName, String image, Set<Product> products, Set<Category> categories) {
       this.id = id;
       this.category = category;
       this.categoryName = categoryName;
       this.image = image;
